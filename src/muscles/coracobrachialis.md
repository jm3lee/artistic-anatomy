---
title: "{{get_desc('coracobrachialis')['icon']}} {{get_desc('coracobrachialis')['title']}}"
---
...
coracobrachialis becomes more superficial because:

1. The deltoid moves upward, reducing its coverage.
1. The pectoralis major stretches, making underlying structures more apparent.
